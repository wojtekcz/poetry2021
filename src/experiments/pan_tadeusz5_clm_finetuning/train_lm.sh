...
PYTHONIOENCODING=UTF-8 python3 run_clm.py \
    ...
    --config_name ${home_dir}/data/pan_tadeusz5/model_config \
    --tokenizer_name ${home_dir}/data/pan_tadeusz5/model_config \
    --fp16 \
    --seed 42 \
    --save_total_limit 2 \
    --save_steps 1000 \
    ...
    --do_eval \
    --validation_file ${home_dir}/data/pan_tadeusz5/dataset/pan_tadeusz.txt \
